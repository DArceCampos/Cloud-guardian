# Cloud Threat Detection & Auto-Remediation Platform
...
Ataque simulado
      |
GuardDuty detecta anomalia
      |
EventBridge captura el evento
      |
Lambda analiza + clasifica severidad
      |
Auto-remediacion (aislar EC2 - revocar keys - bloquear IP)
      |
...
| **AWS Config** | cobra por recurso registrado (~$1-3/mes desde el día 1) |
